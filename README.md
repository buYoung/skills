...
| [react-vite-guide](skills/react-vite-guide/) | Thin React 18/19 + Vite 7/8 integration router for lazy/chunk boundaries, React Compiler and `@vitejs/plugin-react`, and stale-chunk recovery UI. |
