...
- [2026-09-07] [JSONinja Live Application Check](./2026-09-07-jetbrains-jsoninja-live-test/review.md): A skill-name-only invocation using `gpt-5.6-sol` / `medium`, covering first-time adoption approval and application, with before/after documents, a diff, and custom-section preservation evidence.
