...
`task-brief-creator-caveman` closes residual ambiguity through one
policy: first gather enough codebase context in Stage 3, then present
every remaining user-owned decision in a Markdown decision table. The
user reviews concrete recommended changes, not vague questions.
