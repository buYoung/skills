...
|---|---|---|---|
| [01-pm-paste-feat.md](01-pm-paste-feat.md) | Pasted PM spec, ~10 lines | `feat` | Long-input case; how Stage 3 codebase review trims As-Is and how Out-of-Scope guards a downstream agent. Saved brief in caveman full. |
...
| [05-stage-4-walkthrough.md](05-stage-4-walkthrough.md) | Korean refactor note | `refactor` | Default Stage 4 interview on a multi-node tree; how the decision tree is walked one question at a time, with codebase-precedence probes pruning two nodes before they reach the user. Behavior Contract precision survives caveman. |
...
`fix` / briefset), `05` for a deeper multi-node walk, `06` for the
smallest caveman conversion. See
`references/stage-4-interview.md` for the full walk policy and
